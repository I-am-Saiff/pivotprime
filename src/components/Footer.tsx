      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            {/* Both of these were href="#" placeholders and went nowhere.
                Destinations supplied by the client, 3 September. The LinkedIn
                one is the canonical company page: her version carried
                /posts/?feedView=all, which is a view state from her own browser
                rather than part of the address.

                target and rel match the three outbound links already on the
                site, on /contact, the homepage press row and the case study
                cards. Unconditional here, unlike the WhatsApp links, because
                these two are always external: there is no environment variable
                that can turn them into an internal path.

                aria-label is the one thing here that is not an href. The icons
                are decorative svg with no text, so before this they were links
                with no accessible name at all. Making them real destinations
                without naming them would have been a worse defect than the one
                being fixed. Strip it if you would rather keep the change to
                hrefs alone. */}
            <a
              href="https://www.linkedin.com/company/pivotprimeconsultancy/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Pivot Prime on LinkedIn"
              className="h-11 w-11 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-forest transition-colors"
            >
            ...
            <a
              href="https://www.instagram.com/pivot_prime/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Pivot Prime on Instagram"
              className="h-11 w-11 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-forest transition-colors"
            >
