        ...
        <header className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <div className="flex items-center gap-3 self-start md:self-end">
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-neutral-300 surface-page text-forest shadow-sm transition-all hover:bg-white hover:border-forest hover:scale-105 focus-visible:ring-2 focus-visible:ring-mid focus-visible:outline-none active:scale-95"
            >
