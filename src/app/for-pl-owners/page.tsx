      ...
      <section className="px-4 pb-8 sm:px-6 lg:px-8">
        <div className="mx-auto mb-4 max-w-4xl rounded-2xl border border-forest/15 bg-forest/[0.04] p-8 text-center backdrop-blur-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <Link href="/services/technology-builds" className="inline-flex items-center justify-center rounded-xl bg-forest border border-forest/20 px-8 py-3.5 text-xs font-bold tracking-wider text-white uppercase transition-all hover:bg-forest hover:text-white hover:scale-105">
